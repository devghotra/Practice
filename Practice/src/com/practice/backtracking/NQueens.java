...
public class NQueens {
    ...
    public ArrayList<ArrayList<String>> solveNQueens(int n) {
        ...
        solveNQueens(n, 0, board, validArrangements);
        return validArrangements;
    }

    private void solveNQueens(int n, int row, String[][] board, ArrayList<ArrayList<String>> validArrangements) {
        if (n == 0) {
        ...
        if (row < board.length) {
            for (int col = 0; col < board.length; col++) {
                ...
                if (valid) {
                    solveNQueens(n - 1, row + 1, copyBoard, validArrangements);
                }
            }
        }
    }
