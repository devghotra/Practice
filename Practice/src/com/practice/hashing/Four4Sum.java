...
public class Four4Sum {
    ...
    public void test() {
        ...
        int[] input = {-477, -476, -471, -462, -440, -400, -398, -394, -394, -393, -389, -386, -350, -346, -338, -315, -273,
                -249, -182, -172, -166, -161, -149, -116, -112, -109, -100, -73, -33, -26, -22, -11, 6, 8, 13, 19, 56, 78,
                101, 102, 111, 140, 155, 158, 181, 205, 211, 225, 232, 242, 254, 265, 281, 308, 310, 320, 320, 364, 366, 381,
                385, 387, 443, 496, 496};
        ...
        for (int i = 0; i <= input.size() - 4; i++) {
            ...
            for (int j = i + 1; j <= input.size() - 3; j++) {
                ...
                while (l < r) {
                    ...
                    if (r < input.size() - 1 && input.get(r).equals(input.get(r + 1))) {
                        r--;
                        continue;
                    }
